    ...
    groups: [
      {
        ...
        items: [
          { id: 'dashboard',       icon: 'home',         label: 'Dashboard',  url: 'https://labs.liquidspace.app/workplace/dashboard' },
          { id: 'teams',           icon: 'users',        label: 'Teams',      url: 'https://labs.liquidspace.app/workplace/teams' },
          { id: 'locations',       icon: 'map-pinned',   label: 'Locations',  url: 'https://labs.liquidspace.app/workplace/locations' },
          { id: 'activity',        icon: 'activity',     label: 'Activity',   children: [
            { id: 'reservations', icon: 'calendar', label: 'Reservations', url: 'https://labs.liquidspace.app/workplace/activity/reservations' },
            { id: 'searches',     icon: 'search',   label: 'Searches',     url: 'https://labs.liquidspace.app/workplace/activity/searches'     },
            { id: 'reviews',      icon: 'star',     label: 'Reviews',      url: 'https://labs.liquidspace.app/workplace/activity/reviews'      },
          ]},
          { id: 'setup',           icon: 'settings',     label: 'Setup',      url: 'https://labs.liquidspace.app/workplace/setup' },
          { id: 'branding',        icon: 'palette',      label: 'Branding',   url: 'https://labs.liquidspace.app/workplace/branding' },
        ],
      },
      {
        id: 'la',
        ...
        items: [
          { id: 'license-tracker', icon: 'file',         label: 'License Tracker', url: 'https://labs.liquidspace.app/license/tracker' },
          { id: 'payments',        icon: 'credit-card',  label: 'Payments',        url: 'https://labs.liquidspace.app/license/payments' },
          { id: 'funding',         icon: 'dollar-sign',  label: 'Funding Sources', url: 'https://labs.liquidspace.app/license/funding' },
          { id: 'tasks',           icon: 'check-square', label: 'Tasks',           url: 'https://labs.liquidspace.app/license/tasks' },
        ],
      },
      {
        id: 'tm',
        ...
        items: [
          { id: 'transactions', icon: 'book-open',    label: 'Transactions', url: 'https://labs.liquidspace.app/transactions/list' },
          { id: 'tm-tasks',     icon: 'check-square', label: 'Tasks',        url: 'https://labs.liquidspace.app/transactions/tasks' },
        ],
      },
    ],
  },
