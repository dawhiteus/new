...
export function AddLicenseModal({ isOpen, onClose, onSave }: AddLicenseModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0" style={{ borderRadius: '12px', border: 'none' }}>
        ...
        <div className="px-8 py-6 grid grid-cols-2 gap-x-6 gap-y-5">
          ...
          <div className="col-span-2">
            ...
            <Select value={formData.notificationPeriod} onValueChange={(v) => set('notificationPeriod', v)}>
              <SelectTrigger className="border-gray-300 md:w-1/2" style={fieldStyle}><SelectValue /></SelectTrigger>
              <SelectContent>
