...
const MOCK_LOCATIONS: Location[] = [
  { id: '1',  type: 'HQ', venue: 'Tel Tech – Beijing HQ',     description: 'Tel Tech – Beijing HQ',     city: 'Chao Yang Qu',        state: 'Bei Jing Shi', geofence: true,  radius: '50', message: "Looks like you are searching for space where we have a Tel Tech Office! We'd love to have you work from our office.", customCTA: true,  ctaText: 'Book at Tel Tech', ctaUrl: 'https://tel.tech/bookadesk' },
  { id: '2',  type: 'HQ', venue: 'Tel Tech – Bengaluru HQ',   description: 'Tel Tech – Bengaluru HQ',   city: 'Bengaluru',           state: 'KA',           geofence: true,  radius: '50', message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '3',  type: 'HQ', venue: 'Tel Tech – Berlin HQ',      description: 'Tel Tech – Berlin HQ',      city: 'Berlin',              state: 'BE',           geofence: false, radius: '',   message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '4',  type: 'HQ', venue: 'Tel Tech – Dublin HQ',      description: 'Tel Tech – Dublin HQ',      city: 'Dublin',              state: 'D',            geofence: true,  radius: '50', message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '5',  type: 'HQ', venue: 'Tel Tech – Gurugram HQ',    description: 'Tel Tech – Gurugram HQ',    city: 'Gurugram',            state: 'Haryana',      geofence: true,  radius: '50', message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '6',  type: 'HQ', venue: 'Tel Tech – London HQ',      description: 'Tel Tech – London HQ',      city: 'London',              state: 'England',      geofence: true,  radius: '50', message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '7',  type: 'HQ', venue: 'Tel Tech – Manila HQ',      description: 'Tel Tech – Manila HQ',      city: 'Bonifacio Global City', state: 'Taguig',     geofence: true,  radius: '50', message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '8',  type: 'HQ', venue: 'Tel Tech – Mexico City HQ', description: 'Tel Tech – Mexico City HQ', city: 'Ciudad de México',    state: 'CDMX',         geofence: true,  radius: '50', message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '9',  type: 'HQ', venue: 'Tel Tech – Milan HQ',       description: 'Tel Tech – Milan HQ',       city: 'Milano',              state: 'Lombardia',    geofence: true,  radius: '50', message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '10', type: 'HQ', venue: 'Tel Tech – Montreal HQ',    description: 'Tel Tech – Montreal HQ',    city: 'Montréal',            state: 'QC',           geofence: true,  radius: '50', message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '11', type: 'HQ', venue: 'Tel Tech – NYC HQ',         description: 'Tel Tech – NYC HQ',         city: 'New York',            state: 'NY',           geofence: true,  radius: '25', message: '', customCTA: false, ctaText: '', ctaUrl: '' },
  { id: '12', type: 'HQ', venue: 'Tel Tech – Paris HQ',       description: 'Tel Tech – Paris HQ',       city: 'Paris',               state: 'Île-de-France',geofence: false, radius: '',   message: '', customCTA: false, ctaText: '', ctaUrl: '' },
